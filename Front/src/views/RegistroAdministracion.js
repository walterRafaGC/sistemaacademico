...
import "../css/margen-registro-adminitracion.css";
  ...
  return (
    ...
    <div className="row">
      ...
      <div className="col-md-9">
        <form onSubmit={handleSubmit} className="custom-form4">
          <div className="container">
            ...
            <div className="mb-3">
              <label
                htmlFor="fotoPersonalAdministrativo"
                className="form-label"
              >
                Fotografia
              </label>
            ...
            <div className="mb-3">
              <label
                htmlFor="departamentoAdministrativo"
                className="form-label"
              >
                Departamento o Area
              </label>
            ...
            <div className="mb-3">
              <label
                htmlFor="repetir_contrasena_profesor"
                className="form-label"
              >
                Repetir Contraseña
              </label>

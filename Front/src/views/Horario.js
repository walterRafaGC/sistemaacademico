  ...
  return (
    <from>
      <div className="container">
        ...
        <div className="mb-3">
          <label htmlFor="profesorHorario" className="form-label">Buscar el nombre del Profesor</label>
          <div>
            <form className="d-flex" role="search">
              <input
                className="form-control me-2"
        ...
        <div className="mb-3">
          <label htmlFor="fechaInicio" className="form-label">Dia de la Semana</label>
          <div className="form-check">
            <input
              className="form-check-input"
              type="checkbox"
        ...
        <div className="mb-3">
          <label htmlFor="profesorHorario" className="form-label">Buscar el nombre de los alumnos</label>
          <div>
            <form className="d-flex" role="search">
              <input
                className="form-control me-2"
        ...
        <div className="mb-3">
          <label htmlFor="seccionHorario" className="form-label">Hora de Inicio</label>
          <input type="time" className="form-control" name="seccion" />
        </div>
        <div className="mb-3">
          <label htmlFor="seccionHorario" className="form-label">Hora de Final</label>
          <input type="time" className="form-control" name="seccion" />
        </div>
        <div className="mb-3">
          ...
          <table className="table table-bordered">
            ...
            <tr>
                ...
                <td className="text-center" colspan="5">INGRESO</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="text-center" colspan="5">RECREO</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="text-center" colspan="5">SALIDA</td>
              </tr>
            </tbody>
          </table>
        </div>
